                    ...
                    <div class="h-100 zNews-item-one">
                        <div class="content">
                            ...
                            <div class="d-flex justify-content-between mt-20">
                                <h2 class="fs-5 fw-semibold mt-1 title">222</h2>
                                <div>
                ...
                <div class="col-md col-sm-12">
                    <div class="h-100 zNews-item-one">
                        <div class="content">
                            ...
                            <div class="d-flex justify-content-between mt-20">
                                <h2 class="fs-5 fw-semibold mt-1 title">111</h2>
                                <div class="d-flex">
                ...
                <div class="col-md col-sm-12">
                    <div class="h-100 zNews-item-one">
                        <div class="content">
                            ...
                            <div class="d-flex justify-content-between mt-20">
                                <h2 class="fs-5 fw-semibold mt-1 title">100</h2>
                                <div class="d-flex">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-md col-sm-12">
                    <div class="h-100 zNews-item-one">
                        <div class="content">
                            ...
                            <div class="d-flex justify-content-between mt-20">
                                <h2 class="fs-5 fw-semibold mt-1 title"></h2>
                                <div class="d-flex">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
