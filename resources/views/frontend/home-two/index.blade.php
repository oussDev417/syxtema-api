...
@section('contents')
    ...
    @if ($sectionSetting?->our_features_section)
        <!-- features-area -->
        @include('frontend.home-two.sections.features-area')
        <!-- features-area-end -->
    @endif
    ...
    @if ($sectionSetting?->featured_course_section)
        <!-- course-area -->
        @include('frontend.home-two.sections.course-area')
        <!-- course-area-end -->
    @endif

    @if ($sectionSetting?->about_section)
        <!-- work-area -->
        @include('frontend.home-two.sections.work-area')
        <!-- work-area-end -->
    @endif
    ...
    @if ($sectionSetting?->counter_section)
        <!-- fact-area -->
        @include('frontend.home-two.sections.fact-area')
        <!-- fact-area-end -->
    @endif

    @if ($sectionSetting?->featured_instructor_section)
        <!-- instructor-area -->
        @include('frontend.home-two.sections.instructor-area')
        <!-- instructor-area-end -->
    @endif

    @if ($sectionSetting?->news_letter_section)
        <!-- newsletter-area -->
        @include('frontend.home-two.sections.newsletter-area')
        <!-- newsletter-area-end -->
    @endif
    ...
    @if ($sectionSetting?->banner_section)
        <!-- instructor-area-two -->
        @include('frontend.home-two.sections.instructor-area-two')
