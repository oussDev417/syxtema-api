    ...
    <section class="all-courses-area section-py-120 top-baseline">
        <div class="container position-relative">
            <div class="preloader-two d-none">
                <div class="loader-icon-two"><img src="{{ asset(Cache::get('setting')->preloader) }}" alt="Chargement"></div>
            </div>
            <div class="row">
                <div class="col-xl-3 col-lg-4">
                    <div class="courses__sidebar_area">
                        ...
                        <aside class="courses__sidebar">
                                    ...
                                    <ul class="list-wrap">
                                        ...
                                        <li>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="price_3">{{ __('Payant') }}</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="courses-widget">
                                <h4 class="widget-title">{{ __('Niveau') }}</h4>
                                <div class="courses-cat-list">
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="form-check">
                                    ...
                                    <div class="courses-top-right m-0 ms-md-auto">
                                        ...
                                        <div class="courses-top-right-select">
                                            <select name="orderby" class="orderby">
                                                <option value="desc">{{ __('Plus récent au plus ancien') }}</option>
                                                <option value="asc">{{ __('Plus ancien au plus récent') }}</option>
                                            </select>
                                        </div>
                                    </div>
