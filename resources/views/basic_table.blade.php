                            ...
                            <table class="table table-bottom-border table-hover align-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="avatar-group justify-content-start">
                                            <li class="h-35 w-35 d-flex b-r-50 overflow-hidden text-bg-primary">
                                                <img src="{{asset('assets/images/avtar/2.png')}}" alt="avatar"
                                                     class="img-fluid">
                                            </li>
                                            <li class="h-35 w-35 d-flex b-r-50 overflow-hidden text-bg-success"
                                                data-bs-toggle="tooltip" data-bs-title="Lennon Briggs">
                                                <img src="{{asset('assets/images/avtar/3.png')}}" alt="avatar"
                                                     class="img-fluid">
                                            </li>
                                            <li class="h-35 w-35 d-flex b-r-50 overflow-hidden text-bg-danger"
                                                data-bs-toggle="tooltip" data-bs-title="Maya Horton">
                                                <img src="{{asset('assets/images/avtar/1.png')}}" alt="avatar"
                                                     class="img-fluid">
                                            </li>
                                        </ul>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="avatar-group justify-content-start">
                                            <li class="h-35 w-35 d-flex b-r-50 overflow-hidden text-bg-primary">
                                                <img src="{{asset('assets/images/avtar/07.png')}}" alt="avatar"
                                                     class="img-fluid">
                                            </li>
                                            <li class="h-35 w-35 d-flex b-r-50 overflow-hidden text-bg-success"
                                                data-bs-toggle="tooltip" data-bs-title="Lennon Briggs">
                                                <img src="{{asset('assets/images/avtar/08.png')}}" alt="avatar"
                                                     class="img-fluid">
                                            </li>
                                            <li class="h-35 w-35 d-flex b-r-50 overflow-hidden text-bg-danger"
                                                data-bs-toggle="tooltip" data-bs-title="Maya Horton">
                                                <img src="{{asset('assets/images/avtar/09.png')}}" alt="avatar"
                                                     class="img-fluid">
                                            </li>
                                        </ul>
                                    </td>
